...
>
> 연관 문서: 분류 스키마 근거 → [`specialty-schema-analysis-2026-05-27.md`](specialty-schema-analysis-2026-05-27.md) · 완료 작업 = git PR 이력(§7) · 외부 크롤 실측 → [`../dev-roadmap.md` 김경재 트랙](../dev-roadmap.md#김경재-트랙--데이터--백엔드)
...
- [ ] **신뢰도 시그널 결손 처리 보정** — 결손 시그널이 반값 기여를 받고 Vision 누락 시 score 100 "확실"로 뒤집히는 버그. 결손은 점수에서 제외 + 근거 종류 수로 등급 천장 제한 + 화면 "수집 안 됨" 표시. 명세·미결정 파라미터: [`confidence-missing-signals-2026-05-29.md`](confidence-missing-signals-2026-05-29.md)
