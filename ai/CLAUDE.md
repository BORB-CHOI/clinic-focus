...
> ⚠️ **V1 4과목 + 강남 88개 PoC 기준**. V2 풀커버(BE 가 mirror 한 강남 502개 → 서울 5개구 1만)에 내과·소아과·산부인과·가정의학과·비뇨의학과·정신건강의학과·치과 등 미커버 과목이 다수. **Phase C 룰 기반 분류기 구현 전에 실 데이터 기반으로 스키마 확장 결정 필요** — task-queue.md Phase A 백로그 항목 참조.
